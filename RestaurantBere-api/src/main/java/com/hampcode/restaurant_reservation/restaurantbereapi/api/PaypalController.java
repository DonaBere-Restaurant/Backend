...
public class PaypalController {
    ...
    public String  createOrder(@RequestParam double totalAmount) {
        String returnUrl = "https://d1ct8aj9nbwjud.cloudfront.net/api/v1/admin/payments/payment";
    ...
    public void handlePaymentSuccess(@RequestParam("token") String token,@RequestParam("reserva") Integer idReserva, HttpServletResponse response) throws IOException, MessagingException {
        ...
        if (successPayment) {
            String redirectUrl = "https://d1ct8aj9nbwjud.cloudfront.net/reservasion/mesas/menu/datos/resumen/pago-completado"; // Cambia esto a la URL de tu frontend
